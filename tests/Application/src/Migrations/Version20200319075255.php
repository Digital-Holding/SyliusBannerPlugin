 ...
 */
final class Version20200319075255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE odiseo_banner_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT NOT NULL, image_name VARCHAR(255) NOT NULL, mobile_image_name VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, locale VARCHAR(255) NOT NULL, INDEX IDX_BC61EAF72C2AC5D3 (translatable_id), UNIQUE INDEX odiseo_banner_translation_uniq_trans (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
